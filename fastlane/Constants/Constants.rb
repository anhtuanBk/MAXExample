...
class Constants
  ...
  def self.WORKSPACE_PATH
    './MAXExample.xcworkspace'
  end

  # Project path
  def self.PROJECT_PATH
    './MAXExample.xcodeproj'
  end

  # bundle ID for Staging app
  def self.BUNDLE_ID_STAGING
    'com.example.max.staging'
  end
  ...
  def self.GSP_STAGING
    './MAXExample/Configurations/Plists/GoogleService/Staging/GoogleService-Info.plist'
  end

  # a gsp file name for production
  def self.GSP_PRODUCTION
    './MAXExample/Configurations/Plists/GoogleService/Production/GoogleService-Info.plist'
  end
